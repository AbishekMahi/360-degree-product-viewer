! function (t) {
    ...
    var r = n(1),
        ...
        u = function (t, e, n) {
            ...
            h && (n = e);
            for (c in n)(f = !l && _ && void 0 !== _[c]) && c in y || (a = f ? _[c] : n[c], y[c] = h && "function" != typeof _[c] ? n[c] : d && f ? i(a, r) : m && _[c] == a ? function (t) {
            ...
            }(a) : v && "function" == typeof a ? i(Function.call, a) : a, v && ((y.virtual || (y.virtual = {}))[c] = a, t & u.R && g && !g[c] && s(g, c, a)))
        };
    ...
    var r = n(5),
        ...
        c = function () {
            var t, e = n(26)("iframe"),
                r = i.length;
            for (e.style.display = "none", n(44).appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write("<script>document.F=Object<\/script>"), t.close(), c = t.F; r--;) delete c.prototype[i[r]];
            return c()
        };
    t.exports = Object.create || function (t, e) {
        var n;
        return null !== t ? (u.prototype = r(t), n = new u, u.prototype = null, n[s] = t) : n = c(), void 0 === e ? n : o(n, e)
    }
}, function (t, e, n) {
    var r = n(24),
        o = Math.min;
    ...
    t.exports = function (t, e, n, d, m, y, g) {
        ...
        if (T && (x = l(T.call(new t))) !== Object.prototype && x.next && (a(x, O, !0), r || u(x, h) || s(x, h, v)), E && P && "values" !== P.name && (j = !0, L = function () {
                return P.call(this)
            }), r && !g || !p && !j && S[h] || s(S, h, L), c[e] = L, c[O] = v, m)
            if (_ = {
                    values: E ? L : w("values"),
                    keys: y ? L : w("keys"),
                    entries: M
    ...
    n(66);
    for (var r = n(1), o = n(7), i = n(14), s = n(2)("toStringTag"), u = "CSSRuleList,CSSStyleDeclaration,CSSValueList,ClientRectList,DOMRectList,DOMStringList,DOMTokenList,DataTransferItemList,FileList,HTMLAllCollection,HTMLCollection,HTMLFormElement,HTMLSelectElement,MediaList,MimeTypeArray,NamedNodeMap,NodeList,PaintRequestList,Plugin,PluginArray,SVGLengthList,SVGNumberList,SVGPathSegList,SVGPointList,SVGStringList,SVGTransformList,SourceBufferList,StyleSheetList,TextTrackCueList,TextTrackList,TouchList".split(","), c = 0; c < u.length; c++) {
        var f = u[c],
            a = r[f],
            l = a && a.prototype;
    ...
    t.exports = function (t) {
        var e, n, u;
        return void 0 === t ? "Undefined" : null === t ? "Null" : "string" == typeof (n = s(e = Object(t), o)) ? n : i ? r(e) : "Object" == (u = r(e)) && "function" == typeof e.callee ? "Arguments" : u
    }
}, function (t, e, n) {
    var r = n(5);
    ...
    h && p || (h = function (t) {
        ...
        d.now(s(g, t, 1))
    } : v ? (o = new v, i = o.port2, o.port1.onmessage = _, r = s(i.postMessage, i, 1)) : a.addEventListener && "function" == typeof postMessage && !a.importScripts ? (r = function (t) {
        a.postMessage(t + "", "*")
    }, a.addEventListener("message", _, !1)) : r = "onreadystatechange" in f("script") ? function (t) {
    ...
    var r = n(37),
        ...
        L = function (t) {
            function e(t) {
                ...
                return d.imagePath = null, d.filePrefix = null, d.fileExtension = null, d.images = [], d.numberOfImages = 0, d.$element = null, d.$image = null, d.dragging = !1, d.index = 0, d.animateInterval = null, d.pressMouseX = null, d.pressIndex = 0, c()(d, {
                    imagePath: r,
                    filePrefix: u,
                    fileExtension: l,
                    numberOfImages: v
                }), d.$element = n, d.images = [].concat(s()(Array(v).keys())).map(function (t) {
                    var e = "" + u + O()(t + 1, 2, "0") + l;
                    return x.a.join(r, e)
                }), d.$element.classList.add("product-viewer"), o.a.all(d.images.map(function (t) {
                    return Object(P.a)(t)
                })).then(function () {
                    return d.setup()
                }).catch(function (t) {
            ...
            return g()(e, t), v()(e, [{
                key: "setup",
                value: function () {
                    this.onPress = this.onPress.bind(this), this.onRelease = this.onRelease.bind(this), this.onMove = this.onMove.bind(this), this.updateIndex = this.updateIndex.bind(this), this.$element.addEventListener("mousedown", this.onPress, !1), this.$element.addEventListener("touchstart", this.onPress, !1), document.addEventListener("mouseup", this.onRelease, !1), document.addEventListener("touchend", this.onRelease, !1), document.addEventListener("mousemove", this.onMove, !1), document.addEventListener("touchmove", this.onMove, !1), this.$image = new Image, this.$image.src = this.images[0], this.$image.classList.add("product-viewer__image"), this.$element.appendChild(this.$image), this.emit("loaded")
                }
            }, {
                key: "onPress",
                value: function (t) {
                    t.preventDefault(), this.dragging = !0, this.emit("press"), this.$element.classList.add("product-viewer--js-press-active"), this.pressMouseX = this._getPageXByEvent(t), this.pressIndex = this.index
                }
            }, {
                key: "onRelease",
                value: function () {
                    this.dragging = !1, this.emit("release", {
                        index: this.index,
                        image: this.images[this.index]
                    }), this.pressMouseX = null, this.$element.classList.remove("product-viewer--js-press-active")
                }
            }, {
                key: "animate360",
                value: function () {
                    var t = this,
                        n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1e3,
                        r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e.easings.EASE_OUT,
                        o = this.index,
                        i = 0;
                    this.animateInterval = setInterval(function () {
                        (i += 1) === t.numberOfImages && clearInterval(t.animateInterval);
                ...
                value: function (t) {
                    ...
                    this.index = t, this.$image.src = this.images[t], this.emit("index", t)
                }
            }, {
                key: "onMove",
                value: function (t) {
                    ...
                    o = o < 0 ? this.numberOfImages - Math.abs(o) : o, this.updateIndex(o), this.emit("delta", {
                        x: e,
    ...
    L.easings = {
        ...
        EASE: S()(.25, .1, .25, 1),
        EASE_IN: S()(0, 0, 1, .5),
        EASE_IN_OUT: S()(.42, 0, .58, 1),
        EASE_OUT: S()(.61, .26, .08, 1.46)
    }, window.ProductViewer = L, e.default = L
}, function (t, e, n) {
    ...
    t.exports = function (t) {
        return function (e, n) {
            var i, s, u = String(o(e)),
                c = r(n),
                f = u.length;
            return c < 0 || c >= f ? t ? "" : void 0 : (i = u.charCodeAt(c), i < 55296 || i > 56319 || c + 1 === f || (s = u.charCodeAt(c + 1)) < 56320 || s > 57343 ? t ? u.charAt(c) : i : t ? u.slice(c, c + 2) : s - 56320 + (i - 55296 << 10) + 65536)
        }
    }
}, function (t, e, n) {
    "use strict";
    ...
    t.exports = n(6) ? Object.defineProperties : function (t, e) {
        o(t);
        for (var n, s = i(e), u = s.length, c = 0; u > c;) r.f(t, n = s[c++], e[n]);
        return t
    }
}, function (t, e, n) {
    var r = n(12),
                ...
                g(function () {
                    for (var r = t._v, o = 1 == t._s, i = 0; n.length > i;) ! function (e) {
                        var n, i, s = o ? e.ok : e.fail,
                            ...
                            f = e.domain;
                        try {
                            s ? (o || (2 == t._h && k(t), t._h = 1), !0 === s ? n = r : (f && f.enter(), n = s(r), f && f.exit()), n === e.promise ? c(w("Promise-chain cycle")) : (i = M(n)) ? i.call(n, u, c) : u(n)) : c(r)
                        } catch (t) {
                            c(t)
                        }
                    }(n[i++]);
        ...
        A = function (t) {
            y.call(c, function () {
                ...
                if (i && (e = b(function () {
                    ...
                    }), t._h = j || I(t) ? 2 : 1), t._a = void 0, i && e.e) throw e.v
            })
        },
        I = function (t) {
            if (1 == t._h) return !1;
    ...
    L || (E = function (t) {
        ...
        then: function (t, e) {
            var n = P(m(this, E));
            return n.ok = "function" != typeof t || t, n.fail = "function" == typeof e && e, n.domain = j ? O.domain : void 0, this._c.push(n), this._a && this._a.push(n), this._s && T(this, !1), n.promise
        },
        catch: function (t) {
        ...
        var t = new r;
        this.promise = t, this.resolve = f(N, t, 1), this.reject = f(F, t, 1)
    }, _.f = P = function (t) {
        return t === E || t === s ? new i(t) : o(t)
    }), l(l.G + l.W + l.F * !L, {
        Promise: E
    }), n(20)(E, "Promise"), n(75)("Promise"), s = n(0).Promise, l(l.S + l.F * !L, "Promise", {
        reject: function (t) {
            var e = P(this);
        ...
        e = t.exports = function (t, e, n, l, h) {
            ...
            if (i(y)) {
                for (p = u(t.length); p > _; _++)
                    if ((m = e ? g(s(v = t[_])[0], v[1]) : g(t[_])) === f || m === a) return m
            } else
    ...
    o(o.S + o.F * !n(55)(function (t) {
        ...
        from: function (t) {
            var e, n, o, l, h = i(t),
                ...
                y = 0,
                g = a(h);
            if (m && (d = r(d, v > 2 ? arguments[2] : void 0, 2)), void 0 == g || p == Array && u(g))
                for (e = c(h.length), n = new p(e); e > y; y++) f(n, y, m ? d(h[y], y) : h[y]);
            else
                for (l = g.call(h), n = new p; !(o = l.next()).done; y++) f(n, y, m ? s(l, d, [o.value, y], !0) : o.value);
            return n.length = y, n
        }
    })
}, function (t, e, n) {
    ...
    t.exports = !c || n(11)(function () {
        ...
        for (var n = s(t), c = arguments.length, f = 1, a = o.f, l = i.f; c > f;)
            for (var h, p = u(arguments[f++]), v = a ? r(p).concat(a(p)) : r(p), d = v.length, m = 0; d > m;) l.call(p, h = v[m++]) && (n[h] = p[h]);
        return n
    } : c
}, function (t, e, n) {
    t.exports = {
    ...
    var r = n(1),
        ...
        V = G && "symbol" == typeof T.iterator ? function (t) {
            return "symbol" == typeof t
        } : function (t) {
            return t instanceof T
        },
        z = function (t, e, n) {
            return t === D && z($, e, n), g(t), e = b(e, !0), g(n), o(C, e) ? (n.enumerable ? (o(t, k) && t[k][e] && (t[k][e] = !1), n = w(n, {
                enumerable: x(0, !1)
            })) : (o(t, k) || L(t, k, x(1, {})), t[k][e] = !0), X(t, e, n)) : L(t, e, n)
        },
        H = function (t, e) {
            g(t);
            for (var n, r = m(e = _(e)), o = 0, i = r.length; i > o;) z(t, n = r[o++], e[n]);
            return t
        },
        K = function (t, e) {
        ...
        J = function (t) {
            ...
            return !(this === D && o(C, t) && !o($, t)) && (!(e || !o(this, t) || !o(C, t) || o(this, k) && this[k][t]) || e)
        },
        q = function (t, e) {
            if (t = _(t), e = b(e, !0), t !== D || !o(C, e) || o($, e)) {
                var n = P(t, e);
                return !n || !o(C, e) || o(t, k) && t[k][e] || (n.enumerable = !0), n
            }
        },
        Y = function (t) {
            for (var e, n = M(_(t)), r = [], i = 0; n.length > i;) o(C, e = n[i++]) || e == k || e == c || r.push(e);
            return r
        },
        Q = function (t) {
            for (var e, n = t === D, r = M(n ? $ : _(t)), i = [], s = 0; r.length > s;) !o(C, e = r[s++]) || n && !o(D, e) || i.push(C[e]);
            return i
        };
    G || (T = function () {
        ...
        var t = h(arguments.length > 0 ? arguments[0] : void 0),
            e = function (n) {
                this === D && e.call($, n), o(this, k) && o(this[k], t) && (this[k][t] = !1), X(this, t, x(1, n))
            };
        return i && W && X(D, t, {
            configurable: !0,
            set: e
        ...
        return this._k
    }), E.f = q, j.f = z, n(57).f = O.f = Y, n(22).f = J, n(34).f = Q, i && !n(16) && u(D, "propertyIsEnumerable", J, !0), v.f = function (t) {
        return B(p(t))
    }), s(s.G + s.W + s.F * !G, {
        Symbol: T
    });
    ...
    }), T.prototype[F] || n(7)(T.prototype, F, T.prototype.valueOf), l(T, "Symbol"), l(Math, "Math", !0), l(r.JSON, "JSON", !0)
}, function (t, e, n) {
    var r = n(19)("meta"),
        o = n(8),
        i = n(9),
    ...
    t.exports = function (t) {
        var e = r(t),
            n = o.f;
        if (n)
            for (var s, u = n(t), c = i.f, f = 0; u.length > f;) c.call(t, s = u[f++]) && e.push(s);
        return e
    }
}, function (t, e, n) {
    var r = n(15);
    ...
    t.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function (t, e, r) {
            try {
                r = n(10)(Function.call, n(58).f(Object.prototype, "__proto__").set, 2), r(t, []), e = !(t instanceof Array)
            } catch (t) {
                e = !0
            }
            return function (t, n) {
    ...
    (function (t) {
        ...
        e.resolve = function () {
            ...
            for (var o = r(t.split("/")), i = r(n.split("/")), s = Math.min(o.length, i.length), u = s, c = 0; c < s; c++)
                if (o[c] !== i[c]) {
                    u = c;
                    break
    ...
    function s() {
        d && p && (d = !1, p.length ? v = p.concat(v) : m = -1, v.length && u())
    }
    ...
    function r(t, e, n) {
        ...
        if (n || 0 === n || (n = " "), " " === (n += "") && e < 10) return o[e] + t;
        for (var r = "";;) {
    ...
    t.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function (t) {
        ...
        if (r(n)) switch (arguments.length) {
            ...
            for (u = Array.prototype.slice.call(arguments, 1), f = n.slice(), o = f.length, c = 0; c < o; c++) f[c].apply(this, u);
        return !0
    }, n.prototype.addListener = function (t, e) {
        var o;
        if (!r(e)) throw TypeError("listener must be a function");
        return this._events || (this._events = {}), this._events.newListener && this.emit("newListener", t, r(e.listener) ? e.listener : e), this._events[t] ? i(this._events[t]) ? this._events[t].push(e) : this._events[t] = [this._events[t], e] : this._events[t] = e, i(this._events[t]) && !this._events[t].warned && (o = s(this._maxListeners) ? n.defaultMaxListeners : this._maxListeners) && o > 0 && this._events[t].length > o && (this._events[t].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[t].length), "function" == typeof console.trace && console.trace()), this
        ...
        if (n = this._events[t], s = n.length, o = -1, n === e || r(n.listener) && n.listener === e) delete this._events[t], this._events.removeListener && this.emit("removeListener", t, e);
        else if (i(n)) {
            for (u = s; u-- > 0;)
    ...
    t.exports = function (t, e, n, r) {
        function o(e) {
            ...
            var a = (e - f[o]) / (f[o + 1] - f[o]),
                l = r + a * p,
                v = s(l, t, n);
            return v >= .001 ? c(e, l, t, n) : 0 === v ? l : u(e, r, r + p, t, n)
        }
        if (!(0 <= t && t <= 1 && 0 <= n && n <= 1)) throw new Error("bezier x values must be in [0, 1] range");
        var f = v ? new Float32Array(h) : new Array(h);
        if (t !== e || n !== r)
            for (var a = 0; a < h; ++a) f[a] = i(a * p, t, n);
        return function (s) {
            return t === e && n === r ? s : 0 === s ? 0 : 1 === s ? 1 : i(o(s), e, r)
        }
    }
}, function (t, e, n) {
    "use strict";
